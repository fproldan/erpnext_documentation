...
## 2. Operaciones con cheques de tercero

A continuación se detalla el ciclo de vida de un cheque de tercero en el sistema.

### 2.1. Recepción de un pago con cheque de tercero
...
### 2.3. Depósito de cheque de tercero
...
### 2.4. Cobro de cheque de tercero
...
### 2.5. Vencimiento de un cheque de tercero
...
Para esto ingresar al cheque y hacer click en *Acciones > Rechazar Entregado*.

> IMPORTANTE: en este caso no se debe crear el asiento de rechazo, sino que se debe cargar la Nota de Débito del proveedor al cual se le entregó el cheque y generar la Nota de débito con el producto Cheque rechazado para volver a generar la deuda del Cliente ya que el pago queda anulado.

### 2.7. Reemplazo de cheque de tercero
...
### 2.8. Transferencia interna con cheques de tercero
